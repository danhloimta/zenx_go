...
export const OtpPurpose = {
  ...
  MANAGE_SENSITIVE_PROFILE: 'MANAGE_SENSITIVE_PROFILE',
} as const;
...
export const SensitiveChallengeMethod = {
  SECRET_CODE: 'SECRET_CODE',
  SECURITY_ANSWER: 'SECURITY_ANSWER',
} as const;
export type SensitiveChallengeMethod =
  (typeof SensitiveChallengeMethod)[keyof typeof SensitiveChallengeMethod];
...
export const GameOperationalStatus = {
  AVAILABLE: 'AVAILABLE',
...
export const GameMilestoneStatus = {
  COMPLETED: 'COMPLETED',
  IN_PROGRESS: 'IN_PROGRESS',
  UPCOMING: 'UPCOMING',
  PLANNED: 'PLANNED',
