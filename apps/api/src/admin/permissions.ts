...
export const PERMISSIONS = {
  ...
  GAME_PLAYERS_TEMPORARY_LOCK: define('game.players.temporary-lock', 'lock', 'GamePlayer'),
  GAME_PLAYERS_PERMANENT_BAN: define('game.players.permanent-ban', 'ban', 'GamePlayer'),
  GAME_PLAYERS_CHAT_MODERATE: define('game.players.chat.moderate', 'moderate', 'GamePlayerChat'),
  GAME_CHAT_HISTORY_VIEW: define('game.chat.history.view', 'read', 'GameChatHistory'),
