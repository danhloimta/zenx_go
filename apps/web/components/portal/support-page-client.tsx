      ...
      <div className="mx-auto max-w-7xl space-y-12">
        ...
        <div className="relative overflow-hidden rounded-3xl border border-emerald-100/80 bg-gradient-to-br from-white via-emerald-50/40 to-sky-50/50 p-8 sm:p-12 lg:p-14 shadow-sm">
          <div className="relative z-10 max-w-3xl">
            ...
            <p className="mt-3.5 text-sm sm:text-base text-slate-600 leading-relaxed max-w-2xl">
              Tìm kiếm câu trả lời nhanh chóng cho các thắc mắc về tài khoản, nạp Coin, giao dịch ví
              và các quy định bảo mật khi trải nghiệm thế giới game.
            </p>
          ...
          <ShieldCheck
            className="pointer-events-none absolute -bottom-10 right-6 size-56 text-emerald-200/40 hidden md:block"
            strokeWidth={0.8}
          />
        </div>
        ...
        <div className="grid gap-6 sm:grid-cols-3">
          <div className="flex items-center gap-4 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 mt-1">
                Tiếp nhận & giải đáp trung bình dưới 15 phút
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 mt-1">
                Dữ liệu trao đổi và giao dịch được mã hóa an toàn
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 mt-1">
                Sẵn sàng hỗ trợ qua Hotline, Email & Ticket
              </p>
            </div>
          </div>
        </div>
        ...
        <section className="space-y-6">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between pb-4 border-b border-slate-200/80">
            ...
            <Button
              asChild
              className="gap-2 font-bold text-xs h-11 px-6 rounded-xl bg-[#00873E] hover:bg-[#007033] shadow-xs"
            >
          ...
          {search.trim() ? (
            <div className="flex items-center justify-between rounded-2xl bg-emerald-50/80 border border-emerald-200/80 px-5 py-3 text-xs text-slate-700">
              <span>
                Tìm thấy <strong className="text-[#00873E] font-bold">{filteredFaqs.length}</strong>{' '}
                kết quả cho từ khóa &ldquo;<strong className="text-slate-900">{search}</strong>
                &rdquo;
              </span>
              <button
                type="button"
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-6 sm:p-8 shadow-sm">
            {query.isLoading ? (
              ...
              <div className="flex min-h-48 flex-col items-center justify-center text-center p-6">
                ...
                <p className="mt-4 font-black text-slate-800 text-base">
                  Không tìm thấy câu hỏi phù hợp
                </p>
                <p className="mt-1 text-xs text-slate-500 max-w-md">
                  Thử tìm kiếm với từ khóa khác hoặc bấm nút bên dưới để gửi yêu cầu hỗ trợ trực
                  tiếp tới kỹ thuật viên.
                </p>
                <Button
                  asChild
                  size="sm"
                  className="mt-5 gap-1.5 text-xs font-bold rounded-xl bg-[#00873E] hover:bg-[#007033] h-10 px-5"
                >
                  <Link href="/support/report-issue">
                    <MessageSquarePlus className="size-4" />
        ...
        <section className="space-y-6 pt-4">
          <div className="pb-4 border-b border-slate-200/80">
            ...
            <p className="mt-1 text-xs sm:text-sm text-slate-500">
              Nếu bạn cần hỗ trợ khẩn cấp hoặc xử lý khiếu nại giao dịch, hãy liên hệ qua các kênh
              dưới đây:
            </p>
          </div>
          ...
          <div className="grid gap-6 sm:grid-cols-3">
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-7 shadow-sm flex flex-col justify-between hover:border-[#00873E]/40 hover:shadow-lg transition-all">
              <div>
                ...
                <h3 className="mt-5 font-black text-slate-900 text-base">
                  Gửi phiếu yêu cầu hỗ trợ
                </h3>
                <p className="mt-2 text-xs sm:text-sm text-slate-600 leading-relaxed">
                  Dành cho các lỗi nạp Coin, hoàn tiền, xác thực tài khoản cần gửi kèm hình ảnh &
                  chứng từ giao dịch.
                </p>
              </div>
              <Button
                asChild
                size="sm"
                className="mt-6 w-full text-xs font-bold rounded-xl h-10 bg-[#00873E] hover:bg-[#007033]"
              >
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-7 shadow-sm flex flex-col justify-between hover:border-[#00873E]/40 hover:shadow-lg transition-all">
              <div>
                ...
                <p className="mt-2 text-xs sm:text-sm text-slate-600 leading-relaxed">
                  Tư vấn viên trực tiếp giải đáp mọi thắc mắc và hướng dẫn khắc phục sự cố nhanh
                  chóng qua điện thoại.
                </p>
              </div>
              <div className="mt-6 flex items-center gap-2">
                ...
                >
                  {copiedType === 'số điện thoại hotline' ? (
                    <Check className="size-4 text-[#00873E]" />
                  ) : (
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-7 shadow-sm flex flex-col justify-between hover:border-[#00873E]/40 hover:shadow-lg transition-all">
              <div>
                ...
                <p className="mt-2 text-xs sm:text-sm text-slate-600 leading-relaxed">
                  Gửi thư mô tả chi tiết vấn đề kèm thông tin giao dịch cần đối soát ngoài giờ hành
                  chính.
                </p>
              </div>
              <div className="mt-6 flex items-center gap-2">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h4 className="text-sm font-black text-slate-900">
                  Bạn đã gửi yêu cầu hỗ trợ trước đó?
                </h4>
                <p className="text-xs text-slate-600 mt-0.5">
                  Kiểm tra phản hồi và tiến độ xử lý của kỹ thuật viên tại trang quản lý yêu cầu.
                </p>
              </div>
            </div>
            <Button
              ...
              size="sm"
              variant="outline"
              className="shrink-0 text-xs font-bold rounded-xl h-11 px-6 bg-white border-slate-200 hover:border-[#00873E]/40 hover:text-[#00873E]"
            >
    ...
    >
      ...
      {open && (
        <div className="border-t border-slate-100/80 px-5 pb-5 pt-4 space-y-4">
          <SupportMarkdown className="text-xs sm:text-sm leading-relaxed text-slate-600">
            {faq.answer}
          </SupportMarkdown>
