...
export default function GameArticlesLoading() {
  return (
    <div className="space-y-4 sm:space-y-5 pb-12 w-full relative">
      ...
      <div className="overflow-hidden rounded-xl border border-slate-200/80 bg-white shadow-2xs divide-y divide-slate-100 p-4 space-y-4">
        {[1, 2, 3, 4, 5].map((v) => (
