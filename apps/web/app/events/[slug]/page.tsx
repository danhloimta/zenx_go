...
function withoutLeadingTitle(contentHtml: string, title?: string) {
  ...
  if (match) {
    ...
    const eventTitle = (title ?? '').trim().toLowerCase();
    if (!eventTitle || headingText === eventTitle) {
